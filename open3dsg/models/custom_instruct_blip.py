...
class InstructBlipForConditionalGeneration(InstructBlipPreTrainedModel):
    ...
    def generate_caption(
        ...
        **generate_kwargs,
        ...
        Args:
            image_embeds (`torch.FloatTensor` of shape (batch_size, num_channels,dim)):
                embeddings of input images to be processed.
            qformer_input_ids (`torch.LongTensor` of shape (batch_size, sequence_length), *optional*):
                The sequence used as a prompt to be fed to the Q-Former module.
            qformer_attention_mask (`torch.LongTensor` of shape (batch_size, sequence_length), *optional*):
                Mask to avoid performing attention on padding token indices.
...
class InstructBlipForConditionalGenerationVisionEncoder(InstructBlipPreTrainedModel):
    config_class = InstructBlipConfig
    main_input_name = "pixel_values"
